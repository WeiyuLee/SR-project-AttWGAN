...
#                    layer3_3 = nf.convolution_layer(layer3_1 + layer3_2,       model_params["conv3_wgan"],    [1,1,1,1], name="conv3_wgan_3",     activat_fn=nf.lrelu, initializer=init)
    ...
    def EDSR_WGAN_att_on_dis_RCAN(self, kwargs):
...
#                    layer3_3 = nf.convolution_layer(layer3_1 + layer3_2,       model_params["conv3_wgan"],    [1,1,1,1], name="conv3_wgan_3",     activat_fn=nf.lrelu, initializer=init)
    ...
    def RCAN_WGAN_att_on_dis(self, kwargs):
        ...
        if net is "Gen":
            ...
            with tf.variable_scope("RCAN_dis", reuse=reuse):     
                ...
                if d_model is "PatchWGAN_GP":
                    ...
                    layer0 = nf.convolution_layer(input_gan,    model_params["conv1_wgan"],    [1,1,1,1], name="conv1_wgan_0",     activat_fn=nf.lrelu, initializer=init)    

                    layer1_1 = nf.convolution_layer(layer0,    model_params["conv1_wgan"],    [1,1,1,1], name="conv1_wgan_1",     activat_fn=nf.lrelu, initializer=init)
                    layer1_2 = nf.convolution_layer(layer1_1,    model_params["conv1_wgan"],    [1,1,1,1], name="conv1_wgan_2",     activat_fn=nf.lrelu, initializer=init)
                    layer1_3 = nf.convolution_layer(layer1_1 + layer1_2,       model_params["conv1_wgan"],    [1,1,1,1], name="conv1_wgan_3",     activat_fn=nf.lrelu, initializer=init)
                    #layer1_att = nf.attention_RCAN(layer1_3, init, name="conv1_att")
                                     
                    layer2_1 = nf.convolution_layer(layer1_3,       model_params["conv2_wgan"],    [1,2,2,1], name="conv2_wgan_1",     activat_fn=nf.lrelu, initializer=init)
                    layer2_2 = nf.convolution_layer(layer2_1,       model_params["conv2_wgan"],    [1,1,1,1], name="conv2_wgan_2",     activat_fn=nf.lrelu, initializer=init)
                    layer2_3 = nf.convolution_layer(layer2_1 + layer2_2,       model_params["conv2_wgan"],    [1,1,1,1], name="conv2_wgan_3",     activat_fn=nf.lrelu, initializer=init)
                    layer2_att = nf.attention_RCAN(layer2_3, init, name="conv2_att")
    ...
    def RCAN_WGAN_att_on_dis_RG3_RCAB20(self, kwargs):
    ...
    def RCAN_WGAN_att_on_dis_v2(self, kwargs):
    ...
    def RCAN_WGAN_att_on_dis_v2_ablation(self, kwargs):
        ...
        # RG
        def residual_group(image_input, initializer, name, RCAB_num=g_rcba):
        ...
        # RIR
        def residual_in_residual(image_input, initializer, name, RG_num=g_rg):
        ...
        def d_rcba_layer(input, model_params, name):
            layer_input = nf.convolution_layer(input,    model_params,    [1,2,2,1], name= name+"_1",     activat_fn=nf.lrelu, initializer=init)
            layer = nf.convolution_layer(layer_input,    model_params,    [1,1,1,1], name=name+"_2",    activat_fn=nf.lrelu, initializer=init)
            layer = nf.convolution_layer(layer,    model_params,    [1,1,1,1], name=name+"_3",    activat_fn=nf.lrelu, initializer=init)    
            layer_att = nf.attention_RCAN(layer, init, name=name+"_att")
            
            layer_output = layer_input + layer_att
        ...
        if net is "Gen":
            ...
            with tf.variable_scope("RCAN_dis", reuse=reuse):     
                ...
                if d_model is "PatchWGAN_GP":
                    ...
                    layer_rcba  = layer1_1 + layer1_att                 
                    for i in range(1, d_rcba):
                        model_param_name = "conv"+str(i+1)+"_wgan"
                        layer_rcba = d_rcba_layer(layer_rcba, model_params[model_param_name], name=model_param_name)

                    layer4_1 = nf.convolution_layer(layer_rcba,       model_params["d_output_wgan"], [1,1,1,1], name="d_output_wgan_1",  activat_fn=nf.lrelu, initializer=init)
                    output = nf.convolution_layer(layer4_1,       model_params["d_output_wgan"], [1,1,1,1], name="d_output_wgan_3",  activat_fn=nf.lrelu, initializer=init)
    ...
    def RCAN_WGAN_att_on_dis_v2_inter(self, kwargs):
        ...
        if net is "Gen":
            ...
            with tf.variable_scope("RCAN_gen", reuse=reuse):     
                ...
                return output_conv_output, interpolation_conv_output
    ...
    def build_model(self, kwargs = {}):
        ...
        model_list = ["RCAN_WGAN_att_on_dis_v2_ablation", "RCAN_WGAN_att_on_dis_v2_inter", "RCAN_WGAN_att_on_dis_v3", "RCAN_WGAN_att_on_dis_v2", "RCAN_WGAN_att_on_dis_RG3_RCAB20", "RCAN_WGAN_att_on_dis", 
