...
class MODEL(object):
    def __init__(self, 
        ...
        self.model_list = ["EDSR_RaGAN", "EDSR_WGAN", "EDSR_WGAN_att", "RCAN_WGAN_att", "RCAN_RSGAN_GP_att", "EDSR_WGAN_MNIST", "EDSR_RaGAN_MNIST"]
...
#                    self.save_best_ckpt(self.checkpoint_dir, self.ckpt_name, best_loss, itera_counter)
    ...
    def build_RCAN_RSGAN_GP_att(self):###
        """
        Build SRCNN model
        """        
        # Define input and label images
    ...
    def train_RCAN_RSGAN_GP_att(self):
        """
        Training process.
        """     
        print("Training...")
